                ...
                <div class="card">
                    ...
                    <div id="collapseTen" class="collapse" aria-labelledby="headingTen" data-parent="#accordionExample">
                        <div class="card-body">
                            ...
                            40 мин.</p>
                            <p><strong>Билеты на самолет можно приобрести по <a href="{{ route('avia') }}" style="text-decoration: underline">ссылке</a>.</strong></p>
                            ...
                            <p>Первый поезд в Крым отправится 23 декабря 2019 года.</p>
