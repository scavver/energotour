        ...
        <div class="container">
            <div class="row pt-3 pb-4">
                <div class="col text-center">
                    <p id="about" class="mb-0">ООО «Туристическая компания Энерго-Тур» является оптовым покупателем услуг объектов размещения в Крыму. Приобретая квоты мест, мы в свою очередь гарантируем нашим заказчикам получение заказанных услуг в полном объеме.
